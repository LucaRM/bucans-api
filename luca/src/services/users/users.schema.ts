...
export const userDataSchema = Type.Pick(userSchema, ['email', 'password', 'githubId', 'avatar', 'username'], {
  $id: 'UserData'
})
...
export const userQueryProperties = Type.Pick(userSchema, ['_id', 'email', 'githubId', 'username'])
